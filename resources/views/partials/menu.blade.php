        ...
        <ul class="nav">
            ...
            <li class="nav-item" id="timer">
                <a href="#" class="nav-link">
                    <i class="fa-fw fas fa fa-hourglass-start nav-icon">
            ...
            <li class="nav-item">
                <a href="{{ route("admin.task") }}" class="nav-link">
                    <i class="nav-icon fas fa-fw fa fa-tasks">
            ...
            <li class="nav-item">
                <a href="{{ route("admin.schedule") }}" class="nav-link">
                    <i class="nav-icon fas fa-fw fa fa-calendar">
...
function switchWorkStatus(data) {
    ...
    let text = $timer.text() == 'Stop Study' ? 'Start Study' : 'Stop Study';
    $timer.text(text);
